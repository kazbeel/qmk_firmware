...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [MEDIA] = LAYOUT_planck_mit(
    RESET,    XXXXXXX,       RM_TOGG,  RM_NEXT,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  TG(GAMING),      XXXXXXX,
    XXXXXXX,  BBL_OS_SHIFT,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_MPRV,  KC_MPLY,  KC_MNXT,  BBL_LOCK,        XXXXXXX,
    XXXXXXX,  XXXXXXX,       XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_VOLD,  KC_MUTE,  KC_VOLU,  BBL_SUSPEND,     XXXXXXX,
    XXXXXXX,  XXXXXXX,       XXXXXXX,  XXXXXXX,  _______,  XXXXXXX,            _______,  XXXXXXX,  XXXXXXX,  BBL_POWER_DOWN,  XXXXXXX
  ),
...
uint16_t get_tapping_term(uint16_t keycode, keyrecord_t *record) {
  ...
  switch(keycode) {
    ...
    case K_GUI:
    case L_ALT:
        if (current_os == BABEL_OS_LINUX || current_os == BABEL_OS_WINDOWS) {
