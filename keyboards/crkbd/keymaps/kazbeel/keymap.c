...
//   ),
  ...
  [MEDIA] = LAYOUT(
    ...
    XXXXXXX,  BBL_OS_SHIFT,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                     XXXXXXX,  KC_MPRV,  KC_MPLY,  KC_MNXT,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,       XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                     XXXXXXX,  KC_VOLD,  KC_MUTE,  KC_VOLU,  XXXXXXX,  XXXXXXX,
                                                 XXXXXXX,  _______,  XXXXXXX, _______,  XXXXXXX,  XXXXXXX
  ),

  [FUNC] = LAYOUT(
    XXXXXXX,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    XXXXXXX,                     XXXXXXX,           XXXXXXX,          BBL_SYSTEM_SEARCH,    XXXXXXX,           BBL_LOCK,        XXXXXXX,
    ...
    XXXXXXX,  KC_F9,    KC_F10,   KC_F11,   KC_F12,   XXXXXXX,                     XXXXXXX,           BBL_SCREENSHOT,   XXXXXXX,              XXXXXXX,           BBL_POWER_DOWN,  XXXXXXX,
